...
/**
 * 
 * ClassName: ChineseUpperUtil Function: 
 * TODO ADD FUNCTION. 
 * date: 2017年5月19日 下午5:28:42
 *
 * @author zhao rui
 * @version
 */
public class ChineseUpperUtil {
	/*
	 * 大写数字规则
	 * 中文大写金额数字应用正楷或行书填写，如壹、贰、叁、肆、伍、陆、柒、捌、玖、拾、佰、仟、万、亿、元、角、分、零、整（正）等字样。不得用一
	 * 、二（两）、三、四、五、六、七、八、九、十、廿、毛、另（或０）填写，不得自造简化字。如果金额数字书写中使用繁体字，如贰、陆、亿、万、圆的，也可。
	 * 中文大写金额数字到
	 * "元"为止的，在"元"之后，应写"整"（或"正"）字，在"角"之后，可以不写"整"（或"正"）字。大写金额数字有"分"的，"分"后面不写
	 * "整"（或"正"）字。 中文大写金额数字前应标明"人民币"字样，大写金额数字有"分"的，"分"后面不写"整"（或"正"）字。
	 * 中文大写金额数字前应标明
	 * "人民币"字样，大写金额数字应紧接"人民币"字样填写，不得留有空白。大写金额数字前未印"人民币"字样的，应加填"人民币"三字
	 ...
	 * "零"字。如￥1680
	 * .32，应写成人民币壹仟陆佰捌拾元零叁角贰分，或者写成人民币壹仟陆佰捌拾元叁角贰分，又如￥107000.53，应写成人民币壹拾万柒仟元零伍角叁分
	 * ，或者写成人民币壹拾万零柒仟元伍角叁分。
	 * 阿拉伯金额数字角位是"0"，而分位不是"0"时，中文大写金额"元"后面应写"零"字。如￥16409.02，
	 * 应写成人民币壹万陆仟肆佰零玖元零贰分；又如￥325.04，应写成人民币叁佰贰拾伍元零肆分。
	 */
	private static final String big = "零壹贰叁肆伍陆柒捌玖"; // 大写
	private static final String[] units = { "仟佰拾", "角分" }; // 单位
